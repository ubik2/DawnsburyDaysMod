    ...
    public static class ClericClassFeatures
    {
        public static IEnumerable<Feat> LoadFonts()
        {
                ...
                .WithOnSheet((CalculatedCharacterSheetValues sheet) =>
            {
                ...
                {
                    int num = values.CurrentLevel switch { < 5 => 4, < 15 => 5, _ => 6 };
                    for (int j = 0; j < num; j++)
                    {
        ...
        public static IEnumerable<Feat> LoadDeitySelectionFeats()
        {
            yield return new DeitySelectionFeat(FeatName.TheOracle, 
                ...
                [FeatName.DomainHealing, FeatName.DomainTravel, FeatName.DomainLuck, FeatName.DomainSun], 
            ...
            yield return new DeitySelectionFeat(FeatName.TheBloomingFlower,
                ...
                NineCornerAlignmentExtensions.All().Except([NineCornerAlignment.NeutralEvil, NineCornerAlignment.ChaoticEvil, NineCornerAlignment.LawfulEvil]).ToArray(),
                [FeatName.HealingFont],
                [FeatName.DomainSun, FeatName.DomainMoon, FeatName.DomainLuck, FeatName.DomainHealing],
                ItemName.Shortbow,
                [RemasterFeats.GetUpdatedSpellId(SpellId.ColorSpray)]);
            ...
            yield return new DeitySelectionFeat(FeatName.TheThunderingTsunami, 
                ...
                NineCornerAlignmentExtensions.All().Except([NineCornerAlignment.LawfulGood, NineCornerAlignment.LawfulNeutral, NineCornerAlignment.LawfulEvil]).ToArray(),
                [FeatName.HealingFont, FeatName.HarmfulFont],
                [FeatName.DomainMoon, FeatName.DomainCold, FeatName.DomainTravel, FeatName.DomainDestruction],
                ItemName.Warhammer,
                [RemasterFeats.GetUpdatedSpellId(SpellId.HideousLaughter)]);
            ...
            yield return new DeitySelectionFeat(FeatName.TheUnquenchableInferno, 
                ...
                NineCornerAlignmentExtensions.All(),
                [FeatName.HealingFont, FeatName.HarmfulFont],
                [FeatName.DomainSun, FeatName.DomainFire, FeatName.DomainDestruction, FeatName.DomainDeath],
                ItemName.Earthbreaker,
                [RemasterFeats.GetUpdatedSpellId(SpellId.BurningHands)]);
            ...
            yield return new DeitySelectionFeat(FeatName.TheCeruleanSky,
                ...
                NineCornerAlignmentExtensions.All(),
                [FeatName.HealingFont, FeatName.HarmfulFont],
                [FeatName.DomainMoon, FeatName.DomainCold, FeatName.DomainTravel, FeatName.DomainUndeath],
                ItemName.Falchion,
                [RemasterFeats.GetUpdatedSpellId(SpellId.ShockingGrasp)]);
        }
